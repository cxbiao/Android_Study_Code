...
import com.bryan.studycodes.utils.DividerGridItemDecoration;

/**
 * Author：Cxb on 2016/9/13 10:10
 */
public class FrescoListActivity extends TitleBaseActivity {
    ...
    private FrescoAdapter mAdapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        recyclerView.setAdapter(new FrescoAdapter(this,imageUrls));
